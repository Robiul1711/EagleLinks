...
const PriceCard = () => {
  const tiers = [
    {
      ...
      image: p1,
      headerBg: "bg-Primary",
      borderColor: "border-Primary shadow-[0_0_20px_rgba(30,144,255,0.3)]",
    ...
    },
    {
      ...
      headerBg: "bg-[#D71E77]",
      borderColor:
        "hover:border-[#D71E77] hover:shadow-[0_0_20px_rgba(216,27,96,0.3)]",
      textColor: "text-[#D71E77]",
      checkColor: "text-[#D71E77]",
      isSelected: false,
      features: [
        {
    ...
    },
    {
      ...
      headerBg: "bg-[#02A83D]",
      borderColor:
        "hover:border-[#02A83D] hover:shadow-[0_0_20px_rgba(16,185,129,0.3)]",
      textColor: "text-[#02A83D]",
      checkColor: "text-[#02A83D]",
      isSelected: false,
      features: [
  ...
  return (
    <div className="flex justify-center items-center flex-col">
      <div className="mb-8 mx-auto relative w-full max-w-sm rounded-full p-[1px] bg-[linear-gradient(90deg,#ff007f_0%,#8b5cf6_100%)] shadow-[0_0_15px_#ff00ff90,0_0_35px_#8b5cf680]">
        ...
        {tiers.map((tier) => (
          <div
            ...
            className={`relative rounded-3xl border-2 bg-[#0E1017] transition-all duration-300 flex flex-col overflow-hidden ${
              tier.isSelected
                ? tier.borderColor
                : "border-white/5 " + tier.borderColor
            }`}
          >
            ...
            <div className="sm:p-4 p-2 flex-1 flex flex-col justify-between gap-8">
                  ...
                  <li key={idx} className="flex items-start gap-3 w-full">
                    ...
                    <div className="sm:text-sm text-xs text-Secondary">
                      <p
                        ...
                        ${feature.isColor ? tier.textColor + " " : ""}
                      `}
                      >
                        {feature.text.includes("All features") ? (
                          <>
                            <span className={tier.textColor}>All features</span>{" "}
                            of Active, plus:
                          </>
                        ) : (
                          feature.text
                      ...
                      {feature.hasLink && (
                        <a
                          href="#"
                          className={`inline-block text-xs mt-1 hover:underline ${tier.textColor}`}
                        >
                          {feature.linkText}
                        </a>
                      )}
              ...
              <div className="w-full flex justify-end items-end mt-auto">
                {tier.isSelected ? (
                  <div className="w-7 h-7 rounded-full bg-custom flex items-center justify-center shadow-md shadow-[#1e90ff]/40">
                    <svg
