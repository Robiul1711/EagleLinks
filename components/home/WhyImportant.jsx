...
const WhyImportant = () => {
  return (
    <section className="relative overflow-hidden py-12 md:py-16 xl:py-20">
      {/* Background Glow */}
      <div className="absolute left-0 bottom-0 h-[150px] w-[150px] md:h-[220px] md:w-[220px] xl:h-[300px] xl:w-[300px] bg-blue-500/10 blur-[80px] md:blur-[120px] xl:blur-[150px]" />
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-12 md:space-y-16 xl:space-y-20">
          {/* First Row */}
          <div className="grid items-center gap-10 md:gap-14 xl:gap-20 lg:grid-cols-2 mt-10 md:mt-14 xl:mt-16">
            {/* Content */}
              ...
              <SectionTitle
                ...
                subtitle={
                  <>
                    ...
                    attracts real engagement, and increases your chances of
            ...
            <div className="flex justify-center lg:justify-end">
              <Image
                ...
                className="
                  ...
                  xl:rounded-[60px]
                  object-cover
                  drop-shadow-[0_0_40px_rgba(0,153,255,.5)]
                "
              />
            </div>
          </div>
                    {/* Second Row */}
          <div className="grid items-center gap-10 md:gap-14 xl:gap-16 lg:grid-cols-2">
            {/* Image */}
              ...
              <SectionTitle
                ...
                subtitle={
                  <>
                    ...
                    lasting success on Instagram—safely, quickly, and
                    effectively.
                  </>
                }
                align="start"
