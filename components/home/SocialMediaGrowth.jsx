...
export default function SocialMediaGrowth() {
  const statsData = [
    { value: "+245%", label: "Engagement Rate", icon: <FiTrendingUp className="text-xl text-white" />, iconBg: "bg-[#FF3B30]" },
    { value: "+180%", label: "Followers Growth", icon: <FiUsers className="text-xl text-white" />, iconBg: "bg-[#AF52DE]" },
    { value: "+320%", label: "Reach Increase", icon: <FiTarget className="text-xl text-white" />, iconBg: "bg-[#007AFF]" },
    { value: "10x", label: "Content Impact", icon: <FiBarChart2 className="text-xl text-white" />, iconBg: "bg-[#34C759]" },
  ];
      ...
      <div className="">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="text-5xl lg:text-6xl font-bold leading-[1.15] text-white tracking-tight">
              Grow Your{" "}
              <span className="block bg-gradient-to-r from-pink-500 to-purple-400 bg-clip-text text-transparent mt-1">
                Instagram Followers
              </span>
            </h2>

            <p className="text-[#99A1AF] text-base lg:text-lg leading-relaxed mt-6 max-w-xl">
              Grow your Instagram audience with data-driven strategies and
              proven tactics. Build an engaged community and expand your reach
              effortlessly.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mt-10">
              {statsData.map((item, i) => (
                ...
                >
                  <div className={`p-3 rounded-xl ${item.iconBg} mb-4 flex items-center justify-center`}>
                    {item.icon}
                  </div>
                  <h3 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">{item.value}</h3>
                  <p className="text-[#99A1AF] text-sm mt-1">{item.label}</p>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-3 mt-10 pt-4 border-t border-white/[0.06]">
              ...
              <p className="text-sm text-[#99A1AF] font-medium">
                Join <span className="text-white font-semibold">50,000+ creators</span> growing their audience
              </p>
            </div>
